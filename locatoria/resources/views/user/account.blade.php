    ...
    <div class="block">
        <div class="info row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="{{$user->name}}" value=""  readonly>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="{{$user->bio}}" value=""  readonly>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="phone" placeholder="{{$user->phone}}"  readonly>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="adresse" placeholder="{{$user->adresse}}"  readonly>
                    <div class="invalid-feedback">
                        Valid number is required.
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="zip_code" placeholder="{{$user->zip_code}}"  readonly>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <a href="http://localhost/WEB/locatoria/public/edit/user/{{$user->id}}"><button class="btn btn-outline-success my-2 my-sm-0" type="submit">Edit</button></a>
                </div>
