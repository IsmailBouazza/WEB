...
<body>
    <div id="app">
        <main class="py-4">
            ...
            <div class="msg">
                <span style="font-size: 1.5em">Hey <?php echo $name ?>,</span><br><br>
            ...
            <a href="{{url('/home')}}"><button style="margin-left: 50%; font-size:2em;" type="button" class="btn btn-dark">Get Started</button></a>
